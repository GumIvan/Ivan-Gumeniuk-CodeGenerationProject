...
df['Cluster_2D'] = km_2d.fit_predict(X_2d)
 
km_full = KMeans(n_clusters=K_OPTIMAL, random_state=42, n_init=10)
df['Cluster_Full'] = km_full.fit_predict(X_scaled)
...
# Centroids
cx = km_2d.cluster_centers_
ax_main.scatter(cx[:, 0], cx[:, 1], s=220, marker='*', color='white',
